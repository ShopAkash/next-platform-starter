...
13:I[94225,["/_next/static/chunks/063e527dbec50fc3.js","/_next/static/chunks/1e5baf3b48201a33.js"],"OutletBoundary"]
14:"$Sreact.suspense"
...
6:["$","main",null,{"className":"container mx-auto px-4 py-8","children":[["$","script",null,{"type":"application/ld+json","dangerouslySetInnerHTML":{"__html":"{\"@context\":\"https://schema.org\",\"@type\":\"BlogPosting\",\"headline\":\"Tailwind CSS Pro Tips\",\"description\":\"Advanced techniques and best practices for using Tailwind CSS\",\"image\":\"http://localhost:3001/images/tailwind-cover.jpg\",\"author\":{\"@type\":\"Person\",\"name\":\"Mike Johnson\"},\"publisher\":{\"@type\":\"Organization\",\"name\":\"MDX Blog\",\"logo\":{\"@type\":\"ImageObject\",\"url\":\"http://localhost:3001/logo.png\"}},\"datePublished\":\"2024-10-25\",\"dateModified\":\"2024-10-25\",\"mainEntityOfPage\":{\"@type\":\"WebPage\",\"@id\":\"http://localhost:3001/blog/tailwind-css-tips\"},\"keywords\":\"tailwind, css, design, frontend, styling\",\"articleSection\":\"CSS\",\"wordCount\":182,\"url\":\"http://localhost:3001/blog/tailwind-css-tips\",\"isPartOf\":{\"@type\":\"Blog\",\"name\":\"MDX Blog\",\"url\":\"http://localhost:3001\"}}"}}],["$","article",null,{"className":"max-w-4xl mx-auto space-y-8","children":[["$","$L3",null,{"href":"/blog","className":"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 mb-6 flex items-center gap-2","children":[["$","svg",null,{"xmlns":"http://www.w3.org/2000/svg","width":24,"height":24,"viewBox":"0 0 24 24","fill":"none","stroke":"currentColor","strokeWidth":2,"strokeLinecap":"round","strokeLinejoin":"round","className":"h-4 w-4","children":[["$","path","1l729n",{"d":"m12 19-7-7 7-7"}],["$","path","x3x0zl",{"d":"M19 12H5"}],"$undefined"]}],"Back to Blog"],"ref":null}],["$","div",null,{"className":"relative h-64 md:h-96 w-full rounded-lg overflow-hidden","children":["$","$La",null,{"src":"/images/tailwind-cover.jpg","alt":"Tailwind CSS Pro Tips","fill":true,"className":"object-cover","priority":true}]}],["$","header",null,{"className":"space-y-6","children":[["$","div",null,{"className":"space-y-4","children":[["$","h1",null,{"className":"text-4xl md:text-5xl font-bold tracking-tight","children":"Tailwind CSS Pro Tips"}],["$","p",null,{"className":"text-xl text-muted-foreground leading-relaxed","children":"Advanced techniques and best practices for using Tailwind CSS"}]]}],["$","div",null,{"className":"rounded-lg border bg-card text-card-foreground shadow-sm","children":["$","div",null,{"className":"p-6","children":[["$","div",null,{"className":"flex flex-wrap items-center gap-6 text-sm text-muted-foreground","children":[["$","div",null,{"className":"flex items-center gap-2","children":[["$","svg",null,{"xmlns":"http://www.w3.org/2000/svg","width":24,"height":24,"viewBox":"0 0 24 24","fill":"none","stroke":"currentColor","strokeWidth":2,"strokeLinecap":"round","strokeLinejoin":"round","className":"h-4 w-4","children":[["$","rect","eu3xkr",{"width":"18","height":"18","x":"3","y":"4","rx":"2","ry":"2"}],["$","line","m3sa8f",{"x1":"16","x2":"16","y1":"2","y2":"6"}],["$","line","18kwsl",{"x1":"8","x2":"8","y1":"2","y2":"6"}],["$","line","xt86sb",{"x1":"3","x2":"21","y1":"10","y2":"10"}],"$undefined"]}],["$","time",null,{"dateTime":"2024-10-25","children":"October 25, 2024"}]]}],["$","div",null,{"className":"flex items-center gap-2","children":[["$","svg",null,{"xmlns":"http://www.w3.org/2000/svg","width":24,"height":24,"viewBox":"0 0 24 24","fill":"none","stroke":"currentColor","strokeWidth":2,"strokeLinecap":"round","strokeLinejoin":"round","className":"h-4 w-4","children":[["$","path","975kel",{"d":"M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"}],["$","circle","17ys0d",{"cx":"12","cy":"7","r":"4"}],"$undefined"]}],["$","span",null,{"children":"Mike Johnson"}]]}],"$undefined"]}],["$","div",null,{"className":"flex flex-wrap items-center gap-2 mt-4","children":[["$","div",null,{"className":"rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border-transparent bg-secondary text-secondary-foreground hover:bg-secondary/80 flex items-center gap-1","children":["$Lb","CSS"]}],["$Lc","$Ld","$Le","$Lf","$L10"]]}]]}]}]]}],"$L11","$L12"]}]]}]
...
c:["$","div","tailwind",{"className":"inline-flex items-center rounded-full border px-2.5 py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground text-xs","children":["#","tailwind"]}]
d:["$","div","css",{"className":"inline-flex items-center rounded-full border px-2.5 py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground text-xs","children":["#","css"]}]
e:["$","div","design",{"className":"inline-flex items-center rounded-full border px-2.5 py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground text-xs","children":["#","design"]}]
...
10:["$","div","styling",{"className":"inline-flex items-center rounded-full border px-2.5 py-0.5 font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 text-foreground text-xs","children":["#","styling"]}]
16:T546,
